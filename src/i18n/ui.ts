...
export const translations = {
  ...
  'features.f4_title': { en: 'No prompt logging', zh: '不记 Prompt' },
  'features.f4_desc': { en: 'Request logs record usage for billing only - never your prompt content. Rotate or delete keys anytime from the console.', zh: '请求日志只记录用量用于计费，绝不记录你的 Prompt 内容。可随时在控制台轮换或删除 Key。' },
