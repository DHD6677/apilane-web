...
export const translations = {
  ...
  'hero.note': { en: 'Official prices at 1/10 to 1/60 · $2 / $5 / $10 / $20 tiers · USDT (TRC20/BSC/ERC20) + BTC', zh: '官方价格的 1/10 至 1/60 · $2 / $5 / $10 / $20 档位 · USDT（TRC20/BSC/ERC20）+ BTC' },
  ...
  'features.f2_desc': { en: 'USDT (TRC20, BSC, ERC20) via epusdt and BTC via self-hosted BTCPay. No credit card required.', zh: '通过 epusdt 支持 USDT（TRC20、BSC、ERC20），通过自建 BTCPay 支持 BTC。无需信用卡。' },
  ...
  'trust.t3_title': { en: 'Self-hosted BTCPay', zh: '自建 BTCPay' },
  'trust.t3_desc': { en: 'Crypto payments run on our own BTCPay Server. No third-party processor ever sees your transaction.', zh: '加密支付运行在我们自建的 BTCPay Server 上。没有任何第三方支付处理方能看到你的交易。' },
  ...
  'trust.t5_title': { en: 'Origin IP never exposed', zh: '源站 IP 不暴露' },
  ...
  'faq.a3': { en: 'Deposit $2, $5, $10, or $20. We accept USDT (TRC20, BSC, ERC20) via epusdt and BTC via our self-hosted BTCPay Server. No credit card required, no third-party payment processor.', zh: '充值 $2、$5、$10 或 $20。我们通过 epusdt 收 USDT（TRC20、BSC、ERC20），通过自建 BTCPay Server 收 BTC。无需信用卡，无第三方支付处理方。' },
  ...
  'faq.a6': { en: 'If a provider is down, requests fail fast and you are not charged for failed calls. You can retry, switch models, or reach us at support@apilane.one. Live status is at status.apilane.one.', zh: '如果供应商宕机，请求会快速失败，失败调用不扣费。你可以重试、切换模型，或联系 support@apilane.one。实时状态见 status.apilane.one。' },
